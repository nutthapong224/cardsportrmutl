...
const Searchfutsal = () => {
  ...
  useEffect(() => {
    const fetchCSVData = async () => {
      const url = import.meta.env.VITE_GOOGLE_SHEETS_CSV_FUTSAL; // Make sure the correct URL is provided
