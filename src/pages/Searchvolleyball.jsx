...
const Searchvolleyball = () => {
  ...
  useEffect(() => {
    const fetchCSVData = async () => {
      const url = import.meta.env.VITE_GOOGLE_SHEETS_CSV_VOLLEYBALL; // Ensure correct URL
      try {
  ...
  const handleViewDetails = (rowId) => {
    navigate(`/playervolleyball/${rowId}`);
  };
...
export default Searchvolleyball;
