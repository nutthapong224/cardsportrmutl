...
const Playerfootball = () => {
  ...
  useEffect(() => {
    const fetchCSVData = async () => {
      const url = import.meta.env.VITE_GOOGLE_SHEETS_CSV_FOOTBALL;
      ...
      try {
        ...
        Papa.parse(csvText, {
          ...
          complete: (result) => {
            ...
            const row = data.find((item) => item.รหัสนักศึกษา === rowIndex);
        ...
        <CardContent>
          ...
          {!flip && (
            <>
              ...
              >
                <span>ชื่อสกุล : </span>
                {rowData.คำนำหน้า} {rowData.ชื่อ} {rowData.นามสกุล}
              </Typography>
              <Typography
                variant="body2"
                sx={{
              ...
              >
                ...
                {rowData.ประเภทกีฬาที่ลงแข่งขัน}
              </Typography>
              <Typography
                variant="body2"
                sx={{
              ...
              >
                <CardMedia
                  ...
                  alt={`${rowData.ชื่อ} ${rowData.นามสกุล}`}
                  sx={{ width: "48%" }}
