...
const Searchhooptakraw = () => {
  ...
  useEffect(() => {
    const fetchCSVData = async () => {
      const url = import.meta.env.VITE_GOOGLE_SHEETS_CSV_HOOPTAKRAW; // Ensure correct URL
      try {
  ...
  const handleViewDetails = (rowId) => {
    navigate(`/playerhooptakraw/${rowId}`);
  };
  ...
  return (
    <Container maxWidth="md" sx={{ mt: 4 }}>
      ...
      >
        ระบบค้นหานักกีฬาเซปักตะกร้อลอดห่วง
      </Typography>
...
export default Searchhooptakraw;
